...
interface ProductionBugsTrendDataPoint {
  date: string;
  created: number;
  resolved: number;
}

interface ProductionBugsTrendChartProps {
  data: ProductionBugsTrendDataPoint[];
...
export function ProductionBugsTrendChart({ data, issues, onIssueClick }: ProductionBugsTrendChartProps) {
